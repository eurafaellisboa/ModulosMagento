 ...
 * @@Modify Date: 2019-09-09 09:09:06
 * @@Function:
 */
...
class Menu extends \Magento\Catalog\Block\Navigation
{
    ...
    public function __construct(
        ...
        $this->_useStoreCode = $context->getScopeConfig()->getValue(
                'web/url/use_store',
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE
            );
            ...
            foreach ($this->_storeManager->getWebsites() as $website) {
                ...
                if(count($groups) > 1){
                    foreach ($groups as $group) {
                        ...
                        if($store){
                            if( $this->_useStoreCode || $store->getCode() == $currentStore->getCode() )  $demo .= '<li class="level1"><a href="' .$store->getBaseUrl(). '"><span class="demo-home">'. $group->getName(). '</span></a></li>';
