...
class RevSliderOutput extends RevSliderFunctions {
	...
	public function set_slider_id($sid){
		$this->slider_id = FA::apply_filters('revslider_set_slider_id', $sid, $this);
	}
	...
	public function set_add_to($add_to) {
		$this->add_to = FA::apply_filters('revslider_set_add_to', $add_to, $this);
	}
	...
	public function get_add_to(){
		return FA::apply_filters('revslider_get_add_to', trim(strtolower($this->add_to)), $this);
	}
	...
	public function set_slider($slider){
		$this->slider = FA::apply_filters('revslider_set_slider', $slider, $this);
	}
	...
	public function get_slider(){
		return FA::apply_filters('revslider_get_slider', $this->slider, $this);
	}
	...
	public function get_slider_id(){
		return FA::apply_filters('revslider_get_slider_id', $this->slider_id, $this);
	}
	...
	public function set_html_id($html_id, $check_for_duplication = true){
		...
		$this->html_id = FA::apply_filters('revslider_set_html_id', $html_id, $this);
	}
	...
	public function set_slide_id($slide_id){
		$this->slide_id = FA::apply_filters('revslider_set_slide_id', $slide_id, $this);
	}
	...
	public function get_slide_id(){
		return FA::apply_filters('revslider_get_slide_id', $this->slide_id, $this);
	}
	...
	public function set_layers($layers){
		$this->layers = FA::apply_filters('revslider_set_layers', $layers, $this);
	}
	...
	public function get_layers(){
		return FA::apply_filters('revslider_get_layers', $this->layers, $this);
	}
	...
	public function set_layer($layer){
		$this->layer = FA::apply_filters('revslider_set_layer', $layer, $this);
	}
	...
	public function get_layer(){
		return FA::apply_filters('revslider_get_layer', $this->layer, $this);
	}
	...
	public function get_html_id($raw = true){
		...
		return FA::apply_filters('revslider_get_html_id', $html_id, $this, $raw);
	}
	...
	public function set_static_slide($slide){
		$this->static_slide = FA::apply_filters('revslider_set_static_slide', $slide, $this);
	}
	...
	public function get_static_slide(){
		return FA::apply_filters('revslider_get_static_slide', $this->static_slide, $this);
	}
	...
	public function get_do_static(){
		return FA::apply_filters('revslider_get_do_static_layers', $this->do_static, $this);
	}
	...
	public function set_custom_settings($settings){
		...
		$this->custom_settings = FA::apply_filters('revslider_set_custom_settings', $settings, $this);
	}
	...
	public function get_custom_settings(){
		return FA::apply_filters('revslider_get_custom_settings', $this->custom_settings, $this);
	}
	...
	public function set_custom_skin($skin){
		$this->custom_skin = FA::apply_filters('revslider_set_custom_skin', $skin, $this);
	}
	...
	public function get_custom_skin(){
		return FA::apply_filters('revslider_get_custom_skin', $this->custom_skin, $this);
	}
	...
	public function set_layer_unique_id(){
		...
		$this->uid = FA::apply_filters('revslider_set_layer_unique_id', $uid, $layer, $this);
	}
	...
	public function get_layer_unique_id(){
		return FA::apply_filters('revslider_get_layer_unique_id', $this->uid, $this);
	}
	...
	public function get_preview_mode(){
		return FA::apply_filters('revslider_get_preview_mode', $this->preview_mode, $this);
	}
	...
	public function set_preview_mode($preview_mode){
		$this->preview_mode = FA::apply_filters('revslider_set_preview_mode', $preview_mode, $this);
		Framework::$rs_preview_mode = $this->preview_mode;
	}
	...
	public function set_markup_export($markup_export){
		$this->markup_export = FA::apply_filters('revslider_set_markup_export', $markup_export, $this);
	}
	...
	public function get_markup_export(){
		return FA::apply_filters('revslider_get_markup_export', $this->markup_export, $this);
	}
	...
	public function get_custom_order(){
		return FA::apply_filters('revslider_get_custom_order', $this->custom_order, $this);
	}
	...
	public function get_language(){
		return FA::apply_filters('revslider_get_language', $this->language, $this);
	}
	...
	public function change_language($language){
		$this->language = FA::apply_filters('revslider_change_language', $language, $this);
	}
	...
	public function set_custom_order($order){
		...
		$this->custom_order = FA::apply_filters('revslider_set_custom_settings', $order, $this);
	}
	...
	public function set_only_published($published){
		$this->only_published = FA::apply_filters('revslider_set_published', $published, $this);
	}
	...
	public function get_only_published(){
		return FA::apply_filters('revslider_get_published', $this->only_published);
	}
	...
	public function set_slides_num_index($index){
		$this->slides_num_index = FA::apply_filters('revslider_set_slides_num_index', $index, $this);
	}
	...
	public function get_slides_num_index(){
		return FA::apply_filters('revslider_get_slides_num_index', $this->slides_num_index, $this);
	}
	...
	public function set_gallery_ids($ids){
		$this->gallery_ids = FA::apply_filters('revslider_set_gallery_ids', $ids, $this);
	}
	...
	public function get_gallery_ids(){
		return FA::apply_filters('revslider_get_gallery_ids', $this->gallery_ids, $this);
	}
	...
	public function set_is_single_slide($single){
		$this->is_single_slide = FA::apply_filters('revslider_set_is_single_slide', $single, $this);
	}
	...
	public function get_is_single_slide(){
		return FA::apply_filters('revslider_get_is_single_slide', $this->is_single_slide, $this);
	}
	...
	public function set_slide($slide){
		$this->slide = FA::apply_filters('revslider_set_slide', $slide, $this);
	}
	...
	public function get_slide(){
		return FA::apply_filters('revslider_get_slide', $this->slide, $this);
	}
	...
	public function add_slider_to_stage($sid, $usage = '', $layout = '', $offset = '', $modal = ''){
		...
		FA::do_action('revslider_add_slider_to_stage_pre', $sid, $this);
		...
		FA::do_action('revslider_add_slider_to_stage_post', $sid, $this);
	...
	public function add_slider_base(){
		try{
			...
			FA::do_action('revslider_add_slider_base_pre', $this);
			 ...
			 **/
			if(version_compare($this->get_val($this->slider, array('settings', 'version')), FA::get_option('revslider_update_version', '6.0.0'), '<')){
			...
			$this->slider = FA::apply_filters('revslider_add_slider_base', $this->slider);

			//check if we are mobile and the slider needs to be printed or not
			if($this->slider->get_param(array('general', 'disableOnMobile'), false) === true && FA::wp_is_mobile()) return false;
			...
			if($this->caching){
				...
				$content	= FA::get_transient($transient);
				if($content !== false){
            ...
            $revapi = (in_array('revapi'.$sid, Framework::$rs_js_collection['revapi'], true)) ? 'revapi'.$sid.'_'.Framework::$rs_slider_serial : 'revapi'.$sid;
			...
			FA::do_action('revslider_add_slider_base_post', $this);
	...
	public function get_slider_wrapper_div(){
		...
		$bg_color	= FA::esc_attr(trim($this->slider->get_param(array('layout', 'bg', 'color'))));
		...
		$style .= 'padding:'.FA::esc_attr($this->slider->get_param(array('layout', 'bg', 'padding'), '0')).';';
		...
		if($type != 'fullscreen'){
			...
			if($position != 'center'){
				...
				$style .= ($ma_l !== '') ? 'margin-left:'.FA::esc_attr($ma_l).';' : '';
				$style .= ($ma_r !== '') ? 'margin-right:'.FA::esc_attr($ma_r).';' : '';
			}
			...
			$style .= ($ma_t !== '') ? 'margin-top:'.FA::esc_attr($ma_t).';' : '';
			$style .= ($ma_b !== '') ? 'margin-bottom:'.FA::esc_attr($ma_b).';' : '';
		}

		//add background image (banner style)
		if($this->slider->get_param(array('layout', 'bg', 'useImage'), false) == true){
			$bg_img_id = FA::esc_attr($this->slider->get_param(array('layout', 'bg', 'imageId')));
			$bg_img_type = FA::esc_attr($this->slider->get_param(array('layout', 'bg', 'imageSourceType'), 'full'));
			$bg_img = FA::esc_attr($this->slider->get_param(array('layout', 'bg', 'image')));
			...
			if($bg_img_type !== 'full' && $bg_img_id !== false && !empty($bg_img_id)){
				$_bg_img = FA::wp_get_attachment_image_src($bg_img_id, $bg_img_type);
				$bg_img = ($_bg_img !== false) ? $_bg_img[0] : $bg_img;
			}

			$bg_img = $this->check_valid_image($bg_img);
			if($bg_img !== false){
				$class .= ' has_background--image';
				$style .= 'background-image:url('.$bg_img.');';
				$style .= 'background-repeat:'.FA::esc_attr($this->slider->get_param(array('layout', 'bg', 'repeat'), 'no-repeat')).';'; //$this->slider->get_param(array('def', 'background', 'repeat'), 'no-repeat')
				$style .= 'background-size:'.FA::esc_attr($this->slider->get_param(array('layout', 'bg', 'fit'), 'cover')).';'; //$this->slider->get_param(array('def', 'background', 'fit'), 'cover')
				$style .= 'background-position:'.FA::esc_attr($this->slider->get_param(array('layout', 'bg', 'position'), 'center center')).';'; //$this->slider->get_param(array('def', 'background', 'position'), 'center center')
			}
		}
		...
		$r = Framework::RS_T3.'<!-- START '.FA::esc_html(str_replace('-', '', $this->slider->get_title())).' REVOLUTION SLIDER '. Framework::RS_REVISION .' --><p class="rs-p-wp-fix"></p>'."\n";
		$r .= Framework::RS_T3.'<rs-module-wrap';
		$this->rs_module_wrap_open = true;
		$r .= ' id="'.$this->get_html_id().'_wrapper"';
		$r .= (!empty($class)) ? ' class="'.trim($class).'"' : '';
		if((FA::is_super_admin() || FA::is_admin_bar_showing()) && FA::current_user_can('edit_theme_options')){
			$r .= ' data-alias="'.FA::esc_attr($this->slider->get_alias()).'"';
		}
		...
		return FA::apply_filters('revslider_get_slider_wrapper_div', $r, $this);
	}
	...
	public function close_slider_wrapper_div(){
		$r = Framework::RS_T3.'</rs-module-wrap>'."\n";
		$r .= Framework::RS_T3.'<!-- END REVOLUTION SLIDER -->'."\n";

		$this->rs_module_wrap_closed = true;

		return FA::apply_filters('revslider_close_slider_wrapper_div', $r, $this);
	}
	...
	public function add_unfloat_html(){
		...
		if($this->slider->get_param(array('layout', 'position', 'addClear'), false) === true){
			$r = Framework::RS_T3.'<div style="clear:both;display:block;width:100%;height:0px"></div>';
		}

		return FA::apply_filters('revslider_add_unfloat_html', $r, $this);
	}
	...
	public function get_slider_div(){
		...
		$r = Framework::RS_T4.'<rs-module id="'. $this->get_html_id() .'"';
		...
		return FA::apply_filters('revslider_get_slider_div', $r, $this);
	}
	...
	public function close_slider_div(){
		$r = Framework::RS_T4.'</rs-module>'."\n";

		$this->rs_module_closed = true;

		return FA::apply_filters('revslider_close_slider_div', $r, $this);
	}
	...
	public function get_slides(){
		...
		echo FA::apply_filters('revslider_get_slides_pre', Framework::RS_T5.'<rs-slides>'."\n", $this);
		...
		foreach($slides as $slide){
			...
			FA::do_action('revslider_add_layer_html', $this->slider, $slide);
		...
		echo FA::apply_filters('revslider_get_slides_post', Framework::RS_T5.'</rs-slides>'."\n", $this);
	...
	public function get_timer_bar(){
		...
		$progress_style = ' style="height: '.FA::esc_attr($progress_height).'px; background: '.$progressbar_color.';"';

		$r = '';
		switch($timer_bar){
			case 'top':
				$r = Framework::RS_T5.'<rs-progress'.$progress_style.'></rs-progress>'."\n";
			break;
			case 'bottom':
				$r = Framework::RS_T5.'<rs-progress class="rs-bottom"'.$progress_style.'></rs-progress>'."\n";
			break;
			case 'hide':
				$r = Framework::RS_T5.'<rs-progress class="rs-bottom" style="visibility: hidden !important;"></rs-progress>'."\n";
			break;
		}
	...
	public function add_slide_li_pre($index){
		...
		//Html rev-main-
		//echo Framework::RS_T6.'<!-- SLIDE  -->'."\n";
		echo Framework::RS_T6.'<rs-slide';
		...
		FA::do_action('revslider_add_li_data', $this->slider, $slide);
	...
	public function add_static_slide_html(){
		...
		if($this->get_do_static() && !empty($static_slide)){
			...
			if(!empty($layers)){
				...
				echo Framework::RS_T5.'<rs-static-layers' . $sof . $slp . '><!--'."\n";
				...
				FA::do_action('revslider_add_static_layer_html', $this->get_slider());

				echo Framework::RS_T5.'--></rs-static-layers>'."\n";
			}
	...
	public function add_slide_main_image(){
		...
		if(!empty($img) && is_array($img)){
			//echo Framework::RS_T7.'<!-- MAIN IMAGE -->'."\n";
			echo Framework::RS_T7.'<img';
			foreach($img as $k => $v){
				echo (trim($v) !== '') ? ' '.$k.'="'.$v.'"' : '';
			}
			echo ' data-no-retina>'."\n";
	...
	public function get_image_data(){
		...
		if($bg_type != 'external'){
			$img['src']	= FA::getImagesHelper()->imageUrl($slide->image_url);
			...
			switch($slide->get_param(array('attributes', 'altOption'), $slide->get_param(array('attributes', 'titleOption'), 'media_library'))){
				case 'media_library':
				default:
					$img['alt'] = FA::get_post_meta($img['id'], '_wp_attachment_image_alt', true);
				break;
				case 'file_name':
				...
				break;
				case 'custom':
					$img['alt'] = FA::esc_attr($slide->get_param(array('attributes', 'alt'), ''));
				break;
			}
			...
			switch($slide->get_param(array('attributes', 'titleOption'), 'media_library')){
				case 'media_library':
				default:
					$img['title'] = FA::get_the_title($img['id']);
				break;
				case 'file_name':
					$info = pathinfo($slide->image_filename);
				...
				break;
				case 'custom':
					$img['title'] = FA::esc_attr($slide->get_param(array('attributes', 'title'), ''));
				break;
			}

			if($img['id'] !== false){
				$data = FA::wp_get_attachment_metadata($img['id']);
			...
			$img['src']		= FA::esc_url($slide->get_param(array('bg', 'externalSrc'), ''));
			$img['alt']		= FA::esc_attr($slide->get_param(array('attributes', 'alt'), ''));
			$img['title']	= FA::esc_attr($slide->get_param(array('attributes', 'title'), ''));
	...
	public function add_zones(){
		...
		foreach($zones as $zs => $zone){ //go through all three zones
			foreach($layers as $layer){
				...
				echo Framework::RS_T6. $this->add_closing_comment() .'<rs-zone id="rrz'.$zs.'_'.$this->slide->get_id().'" class="rev_row_zone_'.$zone.'" style="z-index: '.$zi.';">';
				echo $this->add_opening_comment()."\n";
				echo $row_layers;
				echo Framework::RS_T7.$this->add_closing_comment().'</rs-zone>'.$this->add_opening_comment()."\n";
	...
	public function add_groups(){
		...
		foreach($layers as $layer){
			...
			echo $this->ld().Framework::RS_T7.'--></rs-group>'.$this->add_opening_comment()."\n";
	...
	private function add_creative_layer(){
		...
		$layers = FA::apply_filters('revslider_putCreativeLayer', $layers, $this, $this->is_static);
		$this->container_mode = '';
	...
	public function add_column($uid){
		...
		if(!empty($column_layers)){
			...
			foreach($column_layers as $layer){
				...
				echo $this->ld().Framework::RS_T7.$this->add_closing_comment().'</rs-column>'.$this->add_opening_comment();
	...
	public function get_html_layer_type(){
		...
		return 'data-type="'.FA::esc_attr($type).'"';
	}
	...
	public function add_layer($row_group_uid = false, $special_type = false){
		$layer = FA::apply_filters('revslider_putLayer_pre', $this->get_layer(), $this, $row_group_uid, $this->is_static, $special_type);
		$this->set_layer($layer);
		...
		echo "\n";
		echo $this->ld().Framework::RS_T7.$this->add_closing_comment();
		echo '<'.$layer_tag."\n";
		echo ($ids != '')					? $this->ld().Framework::RS_T8.$ids." \n" : '';
		echo ($html_class !== '')			? $this->ld().Framework::RS_T8.$html_class."\n" : '';
		echo ($html_simple_link !== '')		? $this->ld().Framework::RS_T8.$html_simple_link."\n" : '';
		echo 								  $this->ld().Framework::RS_T8.$html_type."\n";
		echo ($html_color !== '')			? $this->ld().Framework::RS_T8.$html_color."\n" : '';
		echo ($html_box_shadow !== '')		? $this->ld().Framework::RS_T8.$html_box_shadow."\n" : '';
		echo ($html_text_shadow !== '')		? $this->ld().Framework::RS_T8.$html_text_shadow."\n" : '';
		echo ($html_responsive !== '')		? $this->ld().Framework::RS_T8.$html_responsive."\n" : '';
		echo ($html_title != '') 			? $this->ld().Framework::RS_T8.$html_title."\n" : '';
		echo ($html_tabindex != '')			? $this->ld().Framework::RS_T8.$html_tabindex."\n" : '';
		echo ($html_rel != '')				? $this->ld().Framework::RS_T8.$html_rel."\n" : '';
		echo ($position != '')				? $this->ld().Framework::RS_T8.$position."\n" : '';
		echo ($html_text != '')				? $this->ld().Framework::RS_T8.$html_text."\n" : '';
		echo ($html_float != '')			? $this->ld().Framework::RS_T8.$html_float."\n" : '';
		echo ($html_dimension != '')		? $this->ld().Framework::RS_T8.$html_dimension."\n" : '';
		echo ($html_spike_data != '')		? $this->ld().Framework::RS_T8.$html_spike_data."\n" : '';
		echo ($html_text_stroke != '')		? $this->ld().Framework::RS_T8.$html_text_stroke."\n" : '';
		echo ($html_visibility != '')		? $this->ld().Framework::RS_T8.$html_visibility."\n" : '';
		echo ($html_column_break != '')		? $this->ld().Framework::RS_T8.$html_column_break."\n" : '';
		echo ($layer_actions != '')			? $this->ld().Framework::RS_T8.$layer_actions."\n" : '';
		echo ($html_svg != '')				? $this->ld().Framework::RS_T8.$html_svg : '';
		echo ($html_base_align != '')		? $this->ld().Framework::RS_T8.$html_base_align."\n" : '';
		echo ($html_resp_offset != '')		? $this->ld().Framework::RS_T8.$html_resp_offset."\n" : '';
		echo ($html_wrapper_ids != '')		? $this->ld().Framework::RS_T8.$html_wrapper_ids."\n" : '';
		echo ($html_wrapper_classes != '')	? $this->ld().Framework::RS_T8.$html_wrapper_classes."\n" : '';
		echo ($html_responsive_data != '')	? $this->ld().Framework::RS_T8.$html_responsive_data."\n" : '';
		echo ($html_transform != '') 		? $this->ld().Framework::RS_T8.$html_transform."\n" : '';
		echo ($html_filters_on_mask != '') 	? $this->ld().Framework::RS_T8.$html_filters_on_mask."\n" : '';
		echo ($html_scrollbased_data != '')	? $this->ld().Framework::RS_T8.$html_scrollbased_data."\n" : '';
		echo ($html_static_data != '')		? $this->ld().Framework::RS_T8.$html_static_data."\n" : '';
		echo ($html_static_pos_data != '')	? $this->ld().Framework::RS_T8.$html_static_pos_data."\n" : '';
		echo ($html_trigger != '')			? $this->ld().Framework::RS_T8.$html_trigger."\n" : '';
		echo ($html_blendmode != '')		? $this->ld().Framework::RS_T8.$html_blendmode."\n" : '';
		//echo ($html_togglehover != '')		? $this->ld().Framework::RS_T8.$html_togglehover."\n" : '';
		echo ($html_hideunder != '')		? $this->ld().Framework::RS_T8.$html_hideunder."\n" : '';
		echo ($html_corners != '')			? $this->ld().Framework::RS_T8.$html_corners."\n" : '';
		echo ($html_disp != '')				? $this->ld().Framework::RS_T8.$html_disp."\n" : '';

		echo ($html_audio_data != '')		? $html_audio_data : '';
		echo ($html_video_data != '')		? $html_video_data : ''; //$this->ld().Framework::RS_T8.   ."\n"
		echo ($html_column_data != '')		? $this->ld().Framework::RS_T8.$html_column_data."\n" : '';
		echo ($html_margin_data != '')		? $this->ld().Framework::RS_T8.$html_margin_data."\n" : '';
		echo ($html_padding_data != '')		? $this->ld().Framework::RS_T8.$html_padding_data."\n" : '';
		echo ($html_border_data != '')		? $this->ld().Framework::RS_T8.$html_border_data."\n" : '';
		echo ($html_frameorder != '')		? $this->ld().Framework::RS_T8.$html_frameorder."\n" : '';
		echo ($html_clip != '')				? $this->ld().Framework::RS_T8.$html_clip."\n" : '';

		echo ($html_frames != '')			? $this->ld().Framework::RS_T8.$html_frames : '';

		if(!empty($loop_data)){
			foreach($loop_data as $ldk => $ld){
				echo ($ld !== '') ? $this->ld().Framework::RS_T8.'data-'.$ldk.'="'.$ld.'"'."\n" : '';
			}
		}



		FA::do_action('revslider_add_layer_attributes', $layer, $this->slide, $this->slider, $this);

		echo $this->ld().Framework::RS_T8.'style="';
		echo $html_inline_style;
		//echo $html_idle_style;
		echo '"'."\n";
		echo $this->ld().Framework::RS_T7.'>';//."\n";
		...
		if($toggle_data['allow'] === true){
			echo "\n".$this->ld().Framework::RS_T8.'<div class="';
			echo ($toggle_data['inverse_content'] === true) ? 'rs-toggled-content' : 'rs-untoggled-content';
			echo '">';
		}

		//echo ($special_type === false && $layertype !== 'video') ? FA::apply_filters('revslider_layer_content', stripslashes($html_layer), $html_layer, $this->slider->get_id(), $this->slide, $layer).' ' : '';
		echo ($special_type === false && $layertype !== 'video') ? FA::apply_filters('revslider_layer_content', $html_layer, $html_layer, $this->slider->get_id(), $this->slide, $layer).' ' : '';
		...
		if($special_type === false){
			echo "\n".$this->ld().Framework::RS_T7.'</'.$layer_tag.'>'.$this->add_opening_comment()."\n";
	...
	public function get_action_link(){
		...
		if(!empty($action)){
			foreach($action as $act){
				...
				$action_type = FA::apply_filters('rs_action_type', $this->get_val($act, 'action'));
				$link_type = FA::apply_filters('rs_action_link_type', $this->get_val($act, 'link_type', ''));
				if($action_type === 'menu'){
					$http      = $this->get_val($act, 'link_help_in', 'keep');
					$menu_link = $this->remove_http($this->get_val($act, 'menu_link', ''), $http);
					$menu_link = FA::do_shortcode($menu_link);
				...
				if($action_type === 'link'){
					if($link_type !== 'jquery'){
						...
						$image_link = FA::do_shortcode($image_link);
						$link_open_in = $this->get_val($act, 'link_open_in', '');
						$link_follow = $this->get_val($act, 'link_follow', '');
	...
	public function get_css_javascript($css_html){
		...
		if($this->usage === 'modal' && $this->ajax_loaded === true || $this->ajax_loaded === true){
			$css = (!FA::is_admin()) ? $css_class->compress_css(rawurlencode($css_html)) : $css_class->compress_css($css_html);
			if(empty(trim($css))) return $html;

			if(!FA::is_admin()){
				$html .= Framework::RS_T4.'<script>'."\n";
				$html .= Framework::RS_T5.'var htmlDivCss = unescape("'. $css .'");'."\n";
				$html .= Framework::RS_T5."var htmlDiv = document.getElementById('rs-plugin-settings-inline-css');"."\n";
				$html .= Framework::RS_T5.'if(htmlDiv) {'."\n";
				$html .= Framework::RS_T6.'htmlDiv.innerHTML = htmlDiv.innerHTML + htmlDivCss;'."\n";
				$html .= Framework::RS_T5.'}else{'."\n";
				$html .= Framework::RS_T6."var htmlDiv = document.createElement('div');"."\n";
				$html .= Framework::RS_T6."htmlDiv.innerHTML = '<style>' + htmlDivCss + '</style>';"."\n";
				$html .= Framework::RS_T6."document.getElementsByTagName('head')[0].appendChild(htmlDiv.childNodes[0]);"."\n";
				$html .= Framework::RS_T5.'}'."\n";
				$html .= Framework::RS_T4.'</script>'."\n";
			}else{
				$me = $this->get_markup_export();
				$html .= ($me === true) ? '<!-- STYLE -->' : '';
				$html .= Framework::RS_T4 .'<style type="text/css">'. $css .'</style>';
				$html .= ($me === true) ? '<!-- /STYLE -->' : '';
			}
		}else{
			$css = $css_class->compress_css($css_html);
			if(empty(trim($css))) return $html;
			Framework::$rs_css_collection[] = $css;
			if($this->caching){
				$cache = RevSliderGlobals::instance()->get('RevSliderCache');
	...
	public function get_html_inline_style(){
		...
		if($img !== '' && !in_array($type, array('group', 'shape', 'row'), true)){
			if($img_t !== 'full' && $img_id !== false && !empty($img_id)){
				$_img = FA::wp_get_attachment_image_src($img_id, $img_t);
	...
	public function get_material_icons_css(){
        ...
        $html = $this->get_css_javascript(Framework::$rs_material_icons_css);
...
rs-module .material-icons {
  ...
  -moz-osx-font-smoothing: grayscale;
	...
	public function get_html_layer_action(&$html_simple_link){
		...
		if(!empty($actions)){
			foreach($actions as $num => $action){
				...
				// Filter the Actions
				$events = FA::apply_filters('rs_action_output_layer_action', $events, $action, $all_actions, $num, $this->slide, $this);
				if(!isset($html_simple_link)){
					$html_simple_link = '';
				}
				$html_simple_link = FA::apply_filters('rs_action_output_layer_simple_link', $html_simple_link, $action, $all_actions, $num, $this->slide, $this->slider, $events, $this);
			}
	...
	public function get_html_class($class, $layer_tag){
		...
		$c = FA::apply_filters('revslider_add_layer_classes', $c, $this->layer, $this->slide, $this->slider);
	...
	public function get_html_svg(){
		...
		if(!empty($svg)){
			foreach($svg as $tag => $vals){
				if($svg_html !== '') $svg_html .= $this->ld().Framework::RS_T8;
				$svg_html .= 'data-'.$tag.'="';
				...
				if(!empty($_frame)){
					foreach($_frame as $_base => $values){
						...
						if($s !== ''){
							...
							if($html !== '') $html .= $this->ld().Framework::RS_T8;
	...
	public function get_html_audio_data(){
		...
		$mp4 = FA::esc_attr($this->remove_http($this->get_val($layer, array('media', 'audioUrl'))));
		...
		if(!empty($mp4))	$data['mp4'] = FA::getImagesHelper()->imageUrl($mp4);
		...
		if(!empty($data)){
			foreach($data as $k => $d){
				if(empty($d)) continue;
				$html .= $this->ld().Framework::RS_T8.'data-'.$k.'="';
				if(is_array($d)){
					foreach($d as $kk => $dd){
						$html .= $kk.':';
	...
	public function get_html_video_data(){
		...
		if(!empty($poster)){
			if($poster_change !== 'full' && $poster !== false && !empty($poster)){
				$_img = FA::wp_get_attachment_image_src($poster, $poster_change);
				$poster = ($_img !== false) ? $_img[0] : $poster;
			}
			$data['poster'] = FA::getImagesHelper()->imageUrl($poster);
	...
	public function get_stream_background_image($layer){
		...
		if($this->slider->get_param('sourcetype') !== 'gallery'){
			if(in_array($this->slider->get_param('sourcetype'), array('post', 'woo', 'woocommerce'), true)){
				$bgi['id'] = FA::get_post_thumbnail_id($slide->get_id());
				if(!empty($bgi['id'])){
					$bgi['size']	= $this->get_val($layer, array('behavior', 'streamSourceType'), 'full');
					$thumbnail_url	= FA::wp_get_attachment_image_src($bgi['id'], $bgi['size']);
	 ...
	 *	- added moved FA::do_shortcode() to a later step
	 **/
	public function get_toggle_data(){
		...
		$toggle['html'] = (!in_array($type, array('image', 'svg', 'column', 'shape'), true)) ? FA::do_shortcode(stripslashes($toggle['html'])) : $toggle['html'];
	...
	public function get_html_layer(){
		...
		switch($type){
			...
			case 'button':
				...
				$html = FA::apply_filters('revslider_modify_layer_text', $text, $layer);
			...
			case 'image':
				...
				if($img_size !== 'full' && $cur_img_id !== false && !empty($cur_img_id)){
					$_urlImage = FA::wp_get_attachment_image_src($cur_img_id, $img_size);
					$urlImage = ($_urlImage !== false) ? $_urlImage[0] : $urlImage;
				}

				if($cur_img_id !== false && !empty($cur_img_id)){
					$img_data = FA::wp_get_attachment_metadata( $cur_img_id );
		...
		//do shortcodes here, so that nl2br is not done within the shortcode content
		$html = (!in_array($type, array('image', 'svg', 'column', 'shape'), true)) ? FA::do_shortcode(stripslashes($html)) : $html;
	...
	public function set_placeholders($text){
		...
		$text = str_replace(array('%home_url%', '{{home_url}}'), FA::esc_url(FA::home_url( '/' )), $text);
		if(isset($post->ID)) $text = str_replace(array('%current_page_link%', '{{current_page_link}}'), FA::get_permalink($post->ID), $text);
		if(isset($post->ID)) $text = FA::apply_filters('revslider_gallery_set_placeholders', $text, $post->ID);
	...
	public function add_html_background_video(){
		...
		switch($video_type){
			...
			case 'twitter':
				...
				if($youtube_id !== ''){
					...
					$data['mp4'] = FA::getImagesHelper()->imageUrl($html_mpeg);
				}
			break;
			case 'streamyoutube':
			case 'streamyoutubeboth':
			...
			case 'html5':
				...
				if(!empty($html_mpeg))	 $data['mp4'] = FA::getImagesHelper()->imageUrl($html_mpeg);
				if($mute_video === false) $data['video']['v'] = intval($volume);
			break;
		}
		...
		//echo $this->ld().Framework::RS_T7."<!-- BACKGROUND VIDEO LAYER -->\n";
		echo $this->ld().Framework::RS_T7.'<rs-bgvideo '."\n";
		if(!empty($data)){
			foreach($data as $k => $d){
				if(empty($d)) continue;
				echo $this->ld().Framework::RS_T8.'data-'.$k.'="';
				if(is_array($d)){
					foreach($d as $kk => $dd){
						echo $kk.':';
	...
	public function get_html_slide_title($raw = false){
		...
		if($this->slider->is_posts()){ //check if we are post based or normal slider
			$title = @FA::get_the_title($slide->get_id());
		}else{
		...
		return ($title !== '') ? $pre.stripslashes(FA::esc_attr($title)).$post : '';
	}
	...
	public function get_html_slide_description(){
		...
		if($this->slider->is_posts()){ //check if we are post based or normal slider
			$the_post = FA::get_post($slide->get_id());
			$description = strip_tags(FA::strip_shortcodes($the_post->post_excerpt));
		}else{
			$description = $slide->get_param(array('info', 'description'), '');
		}

		$description = trim(str_replace(array("\'", '\"'), array("'", '"'), FA::esc_attr($description)));
	...
	public function get_thumb_url(){
		...
		if(
			...
			if(empty($url)){ //try to get resized thumb
				$url = FA::getImagesHelper()->rev_aq_resize($slide->image_url, $w, $h, true, true, true);
			}else{
				$url = FA::getImagesHelper()->rev_aq_resize($url, $w, $h, true, true, true);
				if(empty($url)){
					$url = $slide->image_url;
					$url = FA::getImagesHelper()->rev_aq_resize($url, $w, $h, true, true, true);
				}
		...
		if($slide->get_param(array('seo', 'set'), false) == true){
			switch($slide->get_param(array('seo', 'type'), 'regular')){
				...
				case 'regular':
					...
					$link	= ($l !== '') ? ' data-link="'.FA::do_shortcode($l).'"'.$target : $link;
				break;
	...
	public function js_get_first_anim_data(){
		...
		if($this->slider->get_param(array('general', 'firstSlide', 'set'), false) == true && $this->slider->get_param('type') !== 'hero'){
			...
			$data = FA::apply_filters('revslider_disable_first_trans', $data, $this->slider);

			if(!empty($data)){
				$ff = true;
				$html .= $this->JTA . Framework::RS_T5.'fanim: {'."\n";
				foreach($data as $k => $v){
					$html .= ($ff === true) ? '' : ','."\n";
					$html .= $this->JTA . Framework::RS_T6.$k.':';
					if(!empty($v)){
						if(is_array($v)){
							$html .= json_encode($v);
						}else{
	...
	public function get_html_extra_params(){
		...
		for($mi = 0; $mi < 10; $mi++){
			...
			$mm = $mi + 1;
			$params .= ($pa !== '') ? ' data-p'.$mm.'="'.stripslashes(FA::esc_attr($pa)).'"' : '';
		}
		...
		switch($slide->get_param(array('bg', 'type'), 'trans')){
			case 'image':
				...
				if(!empty($id) && intval($id) !== 0){
					$data = FA::wp_get_attachment_metadata($id);
				}
	...
	public function remove_slide_if_mobile($slides){
		...
		$mobile = (FA::wp_is_mobile() || strstr($usragent,'Android') || strstr($usragent,'webOS') || strstr($usragent,'iPhone') ||strstr($usragent,'iPod') || strstr($usragent,'iPad') || strstr($usragent,'Windows Phone')) ? true : false;
	...
	private function modify_settings(){
		...
		$settings = FA::apply_filters('revslider_modify_slider_settings', $settings, $this->get_slider_id());
	...
	private function modify_preview_mode_settings(){
		$js_to_body = FA::apply_filters('revslider_modify_preview_mode_settings', false);
		...
		foreach($gf as $gfk => $gfv){
			...
			if(!empty($gfv['subsets'])){
				foreach($gfv['subsets'] as $ssk => $ssv){
					if(array_search(FA::esc_attr($gfk.'+'.$ssv), $gfsub) !== false){
						$subsets[] = $ssv;
					}
				}
			}
    ...
    public function get_transient_alias(){
        ...
        $args = array(
            ...
            'serial'    => Framework::$rs_slider_serial,
            'admin'        => FA::is_admin(),
	...
	public function get_html_js_start_size($optFullWidth, $optFullScreen){
		...
		if(!$this->get_markup_export()){ //not needed for html markup export
			$html .= 'require([\'setREVStartSize\'], function(setREVStartSize) {';
			...
			if($this->slider->get_param('layouttype') == 'fullscreen'){
				$html .= "offsetContainer:'". FA::esc_attr($this->slider->get_param(array('size', 'fullScreenOffsetContainer'), '')) ."',";
				$html .= "offset:'". FA::esc_attr($this->slider->get_param(array('size', 'fullScreenOffset'), '')) ."',";
			}
	...
	public function print_error_message($message, $open_page = false){
		...
		$url = (empty($html_id) || !FA::is_user_logged_in() || $id === '') ? '' : FA::getBackendUrl('nwdthemes_revslider/revslider/builder') . '?id=' . $id;
		$page_url = ($open_page === true && FA::is_user_logged_in()) ? get_edit_post_link() : '';

		$html .= ($this->rs_module_wrap_open === false) ? Framework::RS_T3.'<rs-module-wrap id="'.$html_id.'_wrapper">'."\n" : '';
		$html .= ($this->rs_module_open === false) ? Framework::RS_T4.'<rs-module id="'.$html_id.'">'."\n" : '';
		$html .= Framework::RS_T5.'<div class="rs_error_message_box">'."\n";
		$html .= Framework::RS_T6.'<div class="rs_error_message_oops">Oops...</div>'."\n";
		$html .= Framework::RS_T6.'<div class="rs_error_message_content">'.FA::esc_html($message);
		$html .= (!empty($url)) ? '<br>'.__('Please follow this link to edit the Slider:', 'revslider') : '';
		$html .= '</div>'."\n";
		$html .= (!empty($url)) ? Framework::RS_T6.'<a href="'.$url.'" target="_blank" class="rs_error_message_button">Edit Module : "'.$this->slider->get_alias().'"</a>'."\n" : '';
		$html .= (!empty($page_url)) ? Framework::RS_T6.'<a href="'.$page_url.'" target="_blank" class="rs_error_message_button">Edit Page</a>'."\n" : '';
		$html .= Framework::RS_T5.'</div>'."\n";
		$html .= ($this->rs_module_wrap_closed === false) ? Framework::RS_T4.'</rs-module>'."\n" : '';
		$html .= ($this->rs_module_closed === false) ? Framework::RS_T3.'</rs-module-wrap>'."\n" : '';

		$html .=  Framework::RS_T3.'<script type="text/javascript">'."\n";
		$html .=  Framework::RS_T4.'var rs_eslider = document.getElementById("'.$html_id.'");'."\n";
		if(FA::is_user_logged_in()){
			$html .=  Framework::RS_T4.'rs_eslider.style.display = "block";'."\n";
			$html .=  Framework::RS_T4.'rs_eslider.style.visibility = "visible";'."\n";
		}else{
			$html .=  Framework::RS_T4.'rs_eslider.style.display = "none";'."\n";
			$html .=  Framework::RS_T4.'console.log("'.FA::esc_html($message).'");'."\n";
		}
		$html .=  Framework::RS_T3.'</script>'."\n";
	...
	private function add_js(){
		...
		$cache			 = RevSliderGlobals::instance()->get('RevSliderCache');
		$me				 = $this->get_markup_export();
		$this->full_js	 = (($this->usage === 'modal' && $this->ajax_loaded === true) || $me === true || $this->ajax_loaded === true) ? true : false;
        ...
        if($this->full_js){
            ...
            Framework::$rs_js_collection['js'][] = $js;
    ...
    public function js_get_start_size(){
        ...
        $html    = '';
        $html    .= Framework::RS_T4.'<script type="text/javascript">'."\n";
        $html    .= Framework::RS_T5.$this->get_html_js_start_size($fw, $fs)."\n";
        $html    .= Framework::RS_T4.'</script>'."\n";
	...
	public function js_get_base_pre(){
        ...
        Framework::$rs_js_collection['revapi'][] = $revapi;
        if($this->caching){
            $cache = RevSliderGlobals::instance()->get('RevSliderCache');
            if(Framework::$rs_js_collection['minimal'] === ''){
                $cache->add_addition('action', 'wp_print_footer_scripts', 'if(window.RS_MODULES === undefined) window.RS_MODULES = {};'."\n", 1);
                $cache->add_addition('action', 'wp_print_footer_scripts', 'if(RS_MODULES.modules === undefined) RS_MODULES.modules = {};'."\n", 1);
            }
            $cache->add_addition('action', 'wp_print_footer_scripts', $this->JTA . Framework::RS_T2.'var    '. $revapi .';'."\n", 1);
        }
        if($this->full_js){
            $html .= $this->JTA . Framework::RS_T.'<script type="text/javascript">'."\n";
            $html .= $this->JTA . Framework::RS_T2.'if(window.RS_MODULES === undefined) window.RS_MODULES = {};'."\n";
            $html .= $this->JTA . Framework::RS_T2.'if(RS_MODULES.modules === undefined) RS_MODULES.modules = {};'."\n";
            $html .= $this->JTA . Framework::RS_T2.'var    '. $revapi .';'."\n";
        }
        $html .= $this->JTA . Framework::RS_T2.'RS_MODULES.modules["'.$html_id_trimmed .'"] = {init:function() {'."\n";
        $html .= $this->JTA . Framework::RS_T3.$revapi.' = jQuery("#'. $html_id .'");'."\n";
        if($this->full_js){
            $html .= ($this->slider->get_param(array('troubleshooting', 'jsNoConflict'), true) === true) ? $this->JTA . Framework::RS_T3.'jQuery.noConflict();'."\n" : '';
        }
		$html = FA::apply_filters('revslider_fe_before_init_script', $html, $this->slider, $html_id); // needed for AddOns
        $html .= $this->JTA . Framework::RS_T3.$revapi.'.revolutionInit({'."\n";
	...
	public function js_get_base_post(){
		...
		$html = '';
		ob_start();
		FA::do_action('revslider_fe_javascript_option_output', $this->slider);
		$js_action = ob_get_contents();
		ob_clean();
		ob_end_clean();

		$html .= $js_action;
		$html .= $this->JTA . Framework::RS_T3.'});'."\n";
		$html .= (in_array('revapi'.$this->slider->get_id(), Framework::$rs_js_collection['revapi'], true) && $revapi !== 'revapi'.$this->slider->get_id()) ? $this->JTA . Framework::RS_T3 . 'var revapi'. $this->slider->get_id() .' = '. $revapi .';'."\n" : ''; //added for addons that use the old revapi style
		$html .= $this->js_get_custom_js();
		$html .= $this->JTA . Framework::RS_T3;

		ob_start();
		FA::do_action('revslider_fe_javascript_output', $this->slider, $this->get_html_id());
		$js_action = ob_get_contents();
		ob_clean();
		ob_end_clean();
		...
		$html .= $js_action;
		$html .= "\n";
        $html .= $this->JTA . Framework::RS_T2.'}} // End of RevInitScript'."\n";

        $minimal = $this->JTA . Framework::RS_T2.'if (window.RS_MODULES.checkMinimal!==undefined) { window.RS_MODULES.checkMinimal();};'."\n";
        if($this->full_js){
            $html .= $minimal;
        }else{
            if(Framework::$rs_js_collection['minimal'] === ''){
                Framework::$rs_js_collection['minimal'] = $minimal;
                if($this->caching){
                    $cache = RevSliderGlobals::instance()->get('RevSliderCache');
        ...
        if($this->full_js){
            $html .= $this->JTA . Framework::RS_T.'</script>'."\n";
        }
	...
	public function get_notices(){
		...
		if($this->orig_html_id !== false){
			//$html .= $this->JTA . Framework::RS_T.'<script type="text/javascript">'."\n";
			$html .= $this->JTA . Framework::RS_T2.'console.log("'.sprintf(__('Warning - ID: %s exists already and was converted to: %s', 'revslider'), $this->orig_html_id, $this->get_html_id()).'")'."\n";
			//$html .= $this->JTA . Framework::RS_T.'</script>'."\n";
		}
	...
	public function js_get_fallback(){
		...
		if($urlhash !== false) {
			$html .= $this->JTA . Framework::RS_T5.'enableDeeplinkHash : true,'."\n";;
		}
		if($apvom !== false) $fb['allowHTML5AutoPlayOnAndroid'] = $apvom;

		if(!empty($fb)){
			$ff = true;
			$html .= $this->JTA . Framework::RS_T5.'fallbacks: {'."\n";
			foreach($fb as $k => $v){
				$html .= ($ff === true) ? '' : ','."\n";
				$html .= $this->JTA . Framework::RS_T6.$k.':';
				$html .= $this->write_js_var($v);
	...
	public function js_get_progressbar(){
		...
		if($s->get_param(array('general', 'progressbar', 'set'), true) === false || $s_type === 'hero'){
			$html = $this->JTA . Framework::RS_T5.'progressBar:{disableProgressBar:true},'."\n";
		} else {
			...
			if(!empty($pb)){
				$ff = true;
				$html .= $this->JTA . Framework::RS_T5.'progressBar: {'."\n";
				foreach($pb as $k => $v){
					$html .= ($ff === true) ? '' : ','."\n";
					$html .= $this->JTA . Framework::RS_T6.$k.':';
					$html .= $this->write_js_var($v);
				...
				if ($pb_ond!==true || $pb_onn!==true || $pb_onm!==true || $pb_ont!==true) {
					$html .= ($ff === true) ? '' : ','."\n";
					$ff = true;
					$html .= $this->JTA . Framework::RS_T6.'visibility: {'."\n";
					if ($pb_ond!=true) {
						$html .= ($ff === true) ? '' : ','."\n";
						$html .= $this->JTA . Framework::RS_T7.'0:false';
						$ff = false;
					}
					if ($pb_onn!=true) {
						$html .= ($ff === true) ? '' : ','."\n";
						$html .= $this->JTA . Framework::RS_T7.'1:false';
						$ff = false;
					}
					if ($pb_ont!=true) {
						$html .= ($ff === true) ? '' : ','."\n";
						$html .= $this->JTA . Framework::RS_T7.'2:false';
						$ff = false;
					}
					if ($pb_onm!=true) {
						$html .= ($ff === true) ? '' : ','."\n";
						$html .= $this->JTA . Framework::RS_T7.'3:false';
						$ff = false;
					}
					$html .= "\n".$this->JTA . Framework::RS_T6.'},'."\n";
				}
				$html .= "\n".$this->JTA . Framework::RS_T6.'},'."\n";
			}
		}
	...
	public function js_get_viewport(){
		...
		if(!empty($vp)){
			$ff = true;
			$html .= $this->JTA . Framework::RS_T5.'viewPort: {'."\n";
			foreach($vp as $k => $v){
				$html .= ($ff === true) ? '' : ','."\n";
				$html .= $this->JTA . Framework::RS_T6.$k.':';
				$html .= $this->write_js_var($v);
	...
	public function js_get_custom_eases(){
		...
		if(!empty($easings)){
			$ff = true;
			$html .= $this->JTA . Framework::RS_T5.'customEases: {'."\n";
			foreach($easings as $v){
				$html .= ($ff === true) ? '' : ','."\n";
				$html .= $this->JTA . Framework::RS_T6.$v.':';
				$html .= 'true';
				$ff = false;
			}
			$html .= "\n".$this->JTA . Framework::RS_T5.'},'."\n";
	...
	public function js_get_scrolleffect(){
		...
		if(!empty($se)){
			$ff = true;
			$html .= $this->JTA . Framework::RS_T5.'scrolleffect: {'."\n";
			foreach($se as $k => $v){
				$html .= ($ff === true) ? '' : ','."\n";
				$html .= $this->JTA . Framework::RS_T6.$k.':';
				$html .= $this->write_js_var($v);
	...
	public function js_get_scrollbased_timeline(){
		...
		if(!empty($se)){
			$ff = true;
			$html .= $this->JTA . Framework::RS_T5.'sbtimeline: {'."\n";
			foreach($se as $k => $v){
				$html .= ($ff === true) ? '' : ','."\n";
				$html .= $this->JTA . Framework::RS_T6.$k.':';
				$html .= $this->write_js_var($v);
	...
	public function js_get_parallax(){
		...
		if(!empty($p)){
			$ff = true;
			$html .= $this->JTA . Framework::RS_T5.'parallax: {'."\n";
			foreach($p as $k => $v){
				$html .= ($ff === true) ? '' : ','."\n";
				$html .= $this->JTA . Framework::RS_T6.$k.':';
				$html .= $this->write_js_var($v);
	...
	public function js_get_overlay(){
		...
		if($do !== 'none'){
			...
			$html .= $this->JTA . Framework::RS_T5.'overlay: {'."\n";
			$html .= $this->JTA . Framework::RS_T6.'type: '.$this->write_js_var($do).",\n";
			$html .= ($colora !== 'transparent') ? $this->JTA . Framework::RS_T6.'colora: '.$this->write_js_var($colora).",\n" : '';
			$html .= (!in_array($colorb, array('', '#000000', '#000'), true)) ? $this->JTA . Framework::RS_T6.'colorb: '.$this->write_js_var($colorb).",\n" : '';
			$html .= (!in_array($size, array('', '1', 1), true)) ? $this->JTA . Framework::RS_T6.'size: '.$this->write_js_var($size).",\n" : '';
			$html .= "\n".$this->JTA . Framework::RS_T5.'},'."\n";
		}
	...
	public function js_get_modal(){
		...
		$c['useAsModal'] = true;
		$c['alias'] = FA::esc_attr($this->slider->get_alias());
        ...
        $ff = true;
        $html .= $this->JTA . Framework::RS_T5.'modal: {'."\n";
		foreach($c as $k => $v){
			$html .= ($ff === true) ? '' : ','."\n";
            $html .= $this->JTA . Framework::RS_T6.$k.':';
			$html .= $this->write_js_var($v);
	...
	public function js_get_carousel(){
		...
		if(!empty($c)){
			$ff = true;
			$html .= $this->JTA . Framework::RS_T5.'carousel: {'."\n";
			foreach($c as $k => $v){
				$html .= ($ff === true) ? '' : ','."\n";
				$html .= $this->JTA . Framework::RS_T6.$k.':';
				$html .= $this->write_js_var($v);
	...
	public function js_get_root(){
		...
		$start_delay = FA::apply_filters('revslider_add_js_delay', $start_delay);
		...
		if($this->frontend_action){
			$keys['ajaxUrl'] = array('v' => FA::admin_url('admin-ajax.php'), 'd' => '');
			//$keys['ajaxNonce'] = ($this->caching) ? array('v' => '##NONCE##', 'd' => '') : array('v' => FA::wp_create_nonce('RevSlider_Front'), 'd' => '');
		}
		...
		if(!empty($keys)){
			foreach($keys as $k => $v){
				...
				$html .= $this->JTA . Framework::RS_T5.$k.':';
	...
	public function js_get_navigation(){
		...
		$html = '';
		if(!empty($h)){
			$html .= $this->JTA . Framework::RS_T5.'navigation: {'."\n";
			$ff = true;
			foreach($h as $key => $value){
				$html .= ($ff === true) ? '' : ','."\n";
				if($key == 'thumbs') $key = 'thumbnails'; //change thumb to thumbnail here
				$html .= $this->JTA . Framework::RS_T6.$key.':';
				if(is_array($value)){
					$html .= ' {'."\n";
					if(!empty($value)){
						$f = true;
						foreach($value as $k => $v){
							$html .= ($f === true) ? '' : ','."\n";
							$html .= $this->JTA . Framework::RS_T7.$k.':';
							...
							if(is_array($v)){
								...
								if(!empty($v)){
									...
									foreach($v as $kk => $vv){
										$html .= ($fff === true) ? '' : ','."\n";
										$html .= $this->JTA . Framework::RS_T8.$kk.':';
										$html .= $this->write_js_var($vv);
										$fff = false;
									}
								}
								$html .= "\n".$this->JTA . Framework::RS_T7.'}';
							}else{
								$html .= $this->write_js_var($v);
							}
							$f = false;
	...
	public static function check_for_shortcodes($mid_content){
		if($mid_content !== null){
			if(FA::has_shortcode($mid_content, 'gallery')){
