...
class RevSliderSliderExportHtml extends RevSliderSliderExport {
	...
	public function replace_export_html_urls(){
		...
		if($this->export_real){ //only include if real export
			...
			if(!$this->usepcl){
				...
				$this->zip->addFile(Framework::$RS_PLUGIN_PATH.'/public/assets/css/rs6.min.css', 'css/rs6.min.css');

				$this->zip->addFile(Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/pe-icon-7-stroke/css/pe-icon-7-stroke.min.css', 'fonts/pe-icon-7-stroke/css/pe-icon-7-stroke.min.css');
				...
				$this->zip->addFile(Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/font-awesome/css/font-awesome.min.css', 'fonts/font-awesome/css/font-awesome.min.css');
				...
				$this->pclzip->add(Framework::$RS_PLUGIN_PATH.'public/assets/css/rs6.min.css', PCLZIP_OPT_REMOVE_PATH, Framework::$RS_PLUGIN_PATH.'public/assets/css/', PCLZIP_OPT_ADD_PATH, 'css/');

				$this->pclzip->add(Framework::$RS_PLUGIN_PATH.'public/assets/fonts/pe-icon-7-stroke/css/pe-icon-7-stroke.min.css', PCLZIP_OPT_REMOVE_PATH, Framework::$RS_PLUGIN_PATH.'public/assets/');
				...
				$this->pclzip->add(Framework::$RS_PLUGIN_PATH.'public/assets/fonts/font-awesome/css/font-awesome.min.css', PCLZIP_OPT_REMOVE_PATH, Framework::$RS_PLUGIN_PATH.'public/assets/');
	...
	public function write_header_html(){
		...
		<head>
			...
			<link rel="stylesheet" type="text/css" href="<?php echo $this->path_fonts; ?>pe-icon-7-stroke/css/pe-icon-7-stroke.min.css">
			<link rel="stylesheet" type="text/css" href="<?php echo $this->path_fonts; ?>font-awesome/css/font-awesome.min.css">

			<!-- REVOLUTION STYLE SHEETS -->
			<link rel="stylesheet" type="text/css" href="<?php echo $this->path_css; ?>rs6.min.css">
