...
class PaymentMethodGn extends \Magento\Payment\Model\Method\Cc
{
    ...
    public function __construct(
        ...
        $paymentAction = $this->_magentoHelper->getPaymentAction();
    ...
    {
        $sale = $this->_magentoHelper->addPayCreditCard($payment, $amount,'createsale');
        ...
        try {
            ...
            if ($sale->getStatus() != 'APPROVED') {
                ...
                $this->_magentoHelper->setLog(__("$msgRetorno").' | '.json_encode($sale));
    ...
    public function capture(\Magento\Payment\Model\InfoInterface $payment, $amount)
    {
        try {
            ...
            $captureSale = $this->_magentoHelper->addPayCreditCard($payment, $amount, 'capturesale');
            ...
            if ($captureSale->getStatus() != 'APPROVED') {
                ...
                $this->_magentoHelper->setLog(__("$msgRetorno") . ' | ' . json_encode($captureSale));
                throw new \Magento\Framework\Exception\LocalizedException(__("$msgRetorno"));
            }
            ...
            $this->_magentoHelper->setLog($exception->getMessage());
            throw new \Magento\Framework\Exception\LocalizedException(__($exception->getMessage()));
        }
