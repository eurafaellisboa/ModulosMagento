                ...
                reFormatCardNumber = function(e) {
                    return setTimeout((function(_this) {
                        return function() {
                            ...
                            document.querySelector('input#Magentoegn_fullname').value = '';
                            document.querySelector('input#magentogn_mm_yy').value = '';
                            document.querySelector('input#magentogn_cc_cid').value = '';
