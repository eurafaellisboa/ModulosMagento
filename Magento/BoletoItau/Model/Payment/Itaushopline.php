...
namespace Magento\BoletoItau\Model\Payment;
...
class Itaushopline extends \Magento\Payment\Model\Method\AbstractMethod
{
    ...
    public function authorize(\Magento\Payment\Model\InfoInterface $payment, $amount)
    {
        ...
        $bankSlipDueDate       = date('dmY', strtotime('+'.$this->storeConfig('payment/boletoitau/days_due_date').' day'));
