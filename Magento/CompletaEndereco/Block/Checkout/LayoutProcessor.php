...
namespace Magento\CompletaEndereco\Block\Checkout;
...
class LayoutProcessor implements \Magento\Checkout\Block\Checkout\LayoutProcessorInterface{
    ...
    public function __construct(
        ...
        \Magento\CompletaEndereco\Helper\Data $addressLineHelper
    ){
    ...
    public function modifyStreetUiComponents($addressResult)
    {
        ...
        if(isset($addressResult['street']['config']['template'])) {
            $addressResult['street']['config']['template'] = 'Magento_CompletaEndereco/group/group';
        }

        if(isset($addressResult['street']['config']['additionalClasses'])) {
            $addressResult['street']['config']['additionalClasses'] = $addressResult['street']['config']['additionalClasses'] . 'completa-endereco';
        }
        ...
        while($lineCount < 4){
            ...
            if(isset($addressResult['street']['children'][$lineCount])){
                ...
                if ( $this->addressLineHelper->isLineEnabled($lineNumber)) {
                    ...
                    $addressResult['street']['children'][$lineCount]['additionalClasses'] = 'completa-endereco-one';
