            ...
            eachIndex(indexes, type, function (i, index, dataFrame, $frame, key, frameData) {
                ...
                function loaded()
                {
                    ...
                    if ($frame.hasClass(stageFrameClass) ) {
                        //.attr('src', 'http://10.10.10.164/magento221/pub/media/catalog/product/cache/352747f212ff9892bfac72a5604a75e2/l/_/l_231493_050400_print.jpg')
                        $img.attr('data-zoom-image', frameData.data.full)
                    }//.attr('data-zoom-image', $img.attr("src"))
                ...
                function waitAndLoad()
                {
                    ...
                    waitFor(function () {
                        ...
                        //jq162 = jQuery.noConflict( true );
                            /*$j("#img_id"+frameData.data.valueid).elevateZoom({
                                zoomType                : "lens",
                                lensShape : "round",
                                lensSize    : 200
                              });*/
