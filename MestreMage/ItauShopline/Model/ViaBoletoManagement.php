...
namespace MestreMage\ItauShopline\Model;
...
class ViaBoletoManagement implements \MestreMage\ItauShopline\Api\ViaBoletoManagementInterface
{
    ...
    public function getViaBoleto($param)
    {
        ...
        $bankSlipDueDate       = date('dmY', strtotime('+'.(int)$this->storeConfig('payment/itaushopline/days_due_date').' day'));
