 ...
 */
namespace MestreMage\ItauShopline\Block\Adminhtml\System\Config;
...
class Extensions extends \Magento\Config\Block\System\Config\Form\Fieldset
{
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        return '<p>'.__('version:').' 1.0.0</p><p>'.__('To configure access:').' <a href="'.$link.'">'.__('Store').' > '.__('Sales').' > '.__('Itau ShopLine Boleto').'</a></p>';
    }
}
