...
namespace MestreMage\ItauShopline\Controller\Index;
...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if(isset($_REQUEST['create_boleto'])) {
            echo '<form action="https://shopline.itau.com.br/shopline/shopline.aspx" method="post" name="form" id="form-boleto">
             <input type="hidden" name="DC" value="' . $_REQUEST['create_boleto'] . '" />
             </form><script>document.getElementById("form-boleto").submit();</script>';
            exit;
        }
