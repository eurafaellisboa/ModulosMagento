                ...
                reFormatCardNumber = function(e) {
                    return setTimeout((function(_this) {
                        return function() {
                            ...
                            document.querySelector('.jp-card-container').style.display = 'Block';
                            document.querySelector('input#mestremagegn_fullname').value = '';
                            document.querySelector('input#mestremagegn_mm_yy').value = '';
                            document.querySelector('input#mestremagegn_cc_cid').value = '';
