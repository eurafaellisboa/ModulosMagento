...
class ConfigProviderGn implements ConfigProviderInterface
{
    ...
    public function getCvvImg(){
        $asset = $this->ccConfig
                    ->createAsset('MestreMage_Getnet::images/cc/cvv.gif');
        return $asset->getUrl();
    }
    /**
     * @return array
    ...
    public function getIcons()
    {
        ...
        foreach (array_keys($types) as $code) {
            ...
            if (!array_key_exists($code, $this->icons)) {
                $asset = $this->ccConfig
                    ->createAsset('MestreMage_Getnet::images/cc/' . strtolower($code) . '.png');
    ...
    {
        return $this->_mestremageHelper->getCardGetnetDecrypt();
    }

	public function MinInstallment()
    {
        $parcelasMinimo = $this->scopeConfig->getValue('payment/mestremagegn/installments_min');
        return $parcelasMinimo;
    }
    public function interestFrom()
    {
        $parcelasMinimo = $this->scopeConfig->getValue('payment/mestremagegn/interest_from');
        return $parcelasMinimo;
    }
    public function interestParcel()
    {
        $parcelasMinimo = $this->scopeConfig->getValue('payment/mestremagegn/interest_parcel');
        return $parcelasMinimo;
    }
    public function TypeInstallment()
    {
        $parcelasMinimo = $this->scopeConfig->getValue('payment/mestremagegn/type_interest');
        return $parcelasMinimo;
    }
    public function cctypesCard()
    {
        $parcelasMinimo = $this->scopeConfig->getValue('payment/mestremagegn/cctypes');
        return $parcelasMinimo;
    }
	public function MaxInstallment()
    {
        $parcelasMaximo = $this->scopeConfig->getValue('payment/mestremagegn/installments');
        return $parcelasMaximo;
    }
    public function layoutCardView()
    {
        $parcelasMaximo = $this->scopeConfig->getValue('payment/mestremagegn/layout_card_view');
        return $parcelasMaximo;
    }
    public function getAcceptsCard()
    {
        ...
        if($this->_customerSession->isLoggedIn()) {
            $save_credit_card = $this->scopeConfig->getValue('payment/mestremagegn/save_credit_card');
        }
    ...
    {
        $parcelasMaximo = $this->scopeConfig->getValue('payment/mestremagegn/homologation_mode_enabled');
