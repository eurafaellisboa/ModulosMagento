        ...
        switch ($statusCode) {
            ...
            case 400:
                ...
                foreach ($response as $error) {
                    throw new \Magento\Framework\Exception\LocalizedException(__('Cod:'.$error->Code.' Msg: '.$error->Message));
                }
                break;
            case 404:
                ...
                break;
            case 500:
                throw new CieloRequestException('Resource not found 500', 500, null);
                break;
            default:
