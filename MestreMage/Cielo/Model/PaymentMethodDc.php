...
class PaymentMethodDc extends \Magento\Payment\Model\Method\Cc
{
    const ROUND_UP = 100;
    protected $_canAuthorize = true;
    protected $_canCapture = false;
    protected $_canRefund = true;
    protected $_code = 'mestremagedc';
    ...
    public function authorize(\Magento\Payment\Model\InfoInterface $payment, $amount)
    {
        ...
        try {
            $sale =  $this->_mestremageHelper->addPayDebitCard($payment, $amount,'createsale');
                if (!in_array($sale->getPayment()->getReturnCode(), ['4', '00', '6'])) {
