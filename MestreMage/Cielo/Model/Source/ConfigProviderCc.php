...
class ConfigProviderCc implements ConfigProviderInterface
{
    ...
    public function getConfig()
    {
        ...
        foreach ($this->methodCodes as $code) {
            if ($this->methods[$code]->isAvailable()) {
                ...
                $config['payment'][$code]['discount_one_parcel'] = $this->getDiscountOneParcel();
			}
        }
	...
	public function getDiscountOneParcel(){
        $array_return = [];
        $array_return['typediscountparcel'] = $this->scopeConfig->getValue('payment/mestremagecc/typediscountparcel');
        $array_return['valuediscountparcel'] = $this->scopeConfig->getValue('payment/mestremagecc/valuediscountparcel');
        $array_return['textdiscountparcel'] = $this->scopeConfig->getValue('payment/mestremagecc/textdiscountparcel');
        return $array_return;
    }
    ...
    {
        $parcelasMinimo = $this->scopeConfig->getValue('payment/mestremagecc/card_type_flag');
        return $parcelasMinimo;
    }
	public function MinInstallment()
    {
        $parcelasMinimo = $this->scopeConfig->getValue('payment/mestremagecc/installments_min');
        return $parcelasMinimo;
    }
    public function interestFrom()
    {
        $parcelasMinimo = $this->scopeConfig->getValue('payment/mestremagecc/interest_from');
        return $parcelasMinimo;
    }
    public function interestParcel()
    {
        $parcelasMinimo = $this->scopeConfig->getValue('payment/mestremagecc/interest_parcel');
        return $parcelasMinimo;
    }
    public function TypeInstallment()
    {
        $parcelasMinimo = $this->scopeConfig->getValue('payment/mestremagecc/type_interest');
        return $parcelasMinimo;
    }
    public function cctypesCard()
    {
        $parcelasMinimo = $this->scopeConfig->getValue('payment/mestremagecc/cctypes');
        return $parcelasMinimo;
    }
	public function MaxInstallment()
    {
        $parcelasMaximo = $this->scopeConfig->getValue('payment/mestremagecc/installments');
        return $parcelasMaximo;
    }
    public function layoutCardView()
    {
        $parcelasMaximo = $this->scopeConfig->getValue('payment/mestremagecc/layout_card_view');
        return $parcelasMaximo;
    }
    public function getAcceptsCard()
    {
        $save_credit_card = $this->scopeConfig->getValue('payment/mestremagecc/save_credit_card');
        return $save_credit_card;
    }

    public function homologationModeEnabled()
    {
        $parcelasMaximo = $this->scopeConfig->getValue('payment/mestremagecc/homologation_mode_enabled');
