                ...
                reFormatCardNumber = function(e) {
                    return setTimeout((function(_this) {
                        return function() {
                            ...
                            document.querySelector('input#mestremagecc_fullname').value = '';
                            document.querySelector('input#mestremagecc_mm_yy').value = '';
                            document.querySelector('input#mestremagecc_cc_cid').value = '';
