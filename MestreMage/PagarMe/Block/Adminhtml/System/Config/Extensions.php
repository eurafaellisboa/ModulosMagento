 ...
 */
namespace MestreMage\PagarMe\Block\Adminhtml\System\Config;
...
class Extensions extends \Magento\Config\Block\System\Config\Form\Fieldset
{
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        return '<p>'.__('version:').' 1.0.3</p><p>'.__('To configure access:').' <a href="'.$link.'">'.__('Store').' > '.__('Sale').' > '.__('Payment Methods').' > '.__('PagarMe').'</a></p>';
    }
}
