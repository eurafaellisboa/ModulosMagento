...
namespace MestreMage\PagarMe\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper {
    ...
    public function getPaymentAction(){
        return $this->_scopeConfig->getValue('payment/pagarmecc/payment_action', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    ...
    public function setLog($msg){
        ...
        if($this->_scopeConfig->getValue('payment/mestremageconfig/log', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)) {
            $writer = new \Zend\Log\Writer\Stream(BP . '/var/log/pagarme_card.log');
