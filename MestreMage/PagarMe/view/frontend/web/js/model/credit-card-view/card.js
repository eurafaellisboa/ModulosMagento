                ...
                reFormatCardNumber = function(e) {
                    return setTimeout((function(_this) {
                        return function() {
                            ...
                            document.querySelector('input#pagarmecc_fullname').value = '';
                            document.querySelector('input#pagarmecc_mm_yy').value = '';
                            document.querySelector('input#pagarmecc_cc_cid').value = '';
